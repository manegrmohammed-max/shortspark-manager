...
CREATE POLICY "public manage urls" ON public.urls FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "public manage logs" ON public.logs FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
